        ...
        <div class="container padding-in-box">
          ...
          <div class="content">
            ...
            <div class="number-element">
              <h3>You have <span>3</span> items in your cart</h3>
            </div>
              ...
              <table>
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <span class="fa fa-times remove-element"></span>
                    </td>
                  </tr>
                  <tr>
                    <td>
                      <img src="assets/image/shop-image-2.png" alt="shop-image"/>
                    </td>
                    <td>
                      Sorry, I am not a model
                    </td>
                  ...
                  <tr>
                    <td>
                      <img src="assets/image/shop-image-3.png" alt="shop-image"/>
                    </td>
                    <td>
                      Sorry, I am not a model
                    </td>
            ...
            <div class="row">
              <div class="col-sm-6 col-md-5 calculation-total">
                ...
                <div class="calculate-shipping">
                  <h3>Calculate Shipping <span class="fa fa-angle-up"></span></h3>
                  <div class="select-country">
                    <select data-placeholder="Select..." class="chosen-select" tabindex="3">
                      <option value=""></option>
                ...
                <div class="input-group button-update-total">
                  <a href="#" class="btn btn-primary">Update Total</a>
              ...
              <div class="col-sm-offset-0 col-md-offset-2 col-sm-6 col-md-5 see-price-buy">
                <div class="line-separator-product"><span></span></div>
